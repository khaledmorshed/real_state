                ...
                child: Column(
                  children: [
                   //const Text("Sign Up", style: TextStyle(fontFamily: 'Poppins', fontStyle: FontStyle.normal, fontSize: 24, fontWeight: FontWeight.w500),),
                    ...
                    //Text("Hey, good to see you again", style: TextStyle(fontFamily: 'Poppins', fontStyle: FontStyle.normal, fontSize: 30, color: ColorManager.signUpHey),),
                    Text("Sign Up", style: TextStyle(fontFamily: 'Poppins', fontStyle: FontStyle.normal, fontSize: 30, color: ColorManager.signUpHey),),
                    const SizedBox(height: 30,),
                    _allTextField(),
                    const SizedBox(height: 30,),
                    ElevatedButton(
